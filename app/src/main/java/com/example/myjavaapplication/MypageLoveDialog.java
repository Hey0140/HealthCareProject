...
public class MypageLoveDialog extends Dialog implements View.OnClickListener {
    private Context context;
    private ArrayList<CommunityItemData> itemList = new ArrayList<>();
    private ArrayList<String> likeList = new ArrayList<>();
    private MypageLoveDialog.OnMypageLoveDialogListener MypageLoveDialogListener;
    private MypageLoveAdapter adapter;
    private UserMedia userData = new UserMedia();
    private int communityPosition = 0;

    public MypageLoveDialog(@NonNull android.content.Context context, UserMedia userData) {
        super(context);
        this.context = context;
        this.userData = userData;
    }

    public interface OnMypageLoveDialogListener{
    ...
    public void setMypageLoveDialogListener(MypageLoveDialog.OnMypageLoveDialogListener onMypageLoveDialogListener){
        this.MypageLoveDialogListener = onMypageLoveDialogListener;
    }
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        adapter = new MypageLoveAdapter(itemList, getContext());
        adapter.setOnHeartClickListener(new MypageLoveAdapter.OnListHeartSelected() {
            @Override
...
//        adapter.setOnItemClickListener(new MypageLoveAdapter.OnListItemSelected() {
//            @Override
